...
```{r}
WTvT200M_GENE <- subset(WTvT200M,ID=='FANCG/ENSG00000221829.11/clean/chr9:35076870-35076970')
...
d <- ggplot(gene_plot, aes(x=condition, y=ratio)) + 
   theme_classic()+ ggtitle("FANCG/chr9:35076870-35076970") + labs(x ='Condition',y = "IR Ratio")
